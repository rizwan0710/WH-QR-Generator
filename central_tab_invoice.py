...
def bina_tab_invoice(tab_invoice_frame, frame_top3, root, pratonton_fn, padam_fn):
    ...
    # 🌟 KONFIGURASI WARNA SERAGAM TAB INVOICE
    ...
    jadual_invoice.tag_configure('checked', background='#E8F5E9', foreground='#1B5E20') # Hijau Lembut Korporat
    ...
    # ─── 🌟 KANAN SEKALI: SUSUNAN ERGONOMIK (REFRESH DI SEBELAH LEFT BUTTON BACK) 🌟 ───
    tk.Button(frame_top3, text="◀ BACK TO MAIN", command=root.destroy, bg="#6C757D", fg="white", font=("Segoe UI", 9, "bold"), width=16, relief="flat", cursor="hand2").pack(side=tk.RIGHT, padx=5)
